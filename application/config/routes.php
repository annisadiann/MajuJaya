...
$route['kasir/simpan']  = 'kasir/simpan';
$route['riwayat']              = 'riwayat/index';
$route['riwayat/simpan_retur'] = 'riwayat/simpan_retur';
$route['invoice']         = 'invoice/index';
$route['invoice/thermal'] = 'invoice/thermal';
$route['retur'] = 'retur/index';
$route['stok']                = 'stok/index';
$route['stok/history/(:num)'] = 'stok/history/$1';
...
$route['barang/edit_nama'] = 'barang/edit_nama';
$route['barang']            = 'barang/index';
$route['barang/hapus']      = 'barang/hapus';
$route['barang/sukses_penjualan'] = 'barang/sukses_penjualan';
$route['invoice'] = 'invoice/index';